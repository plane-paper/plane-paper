# Hi there! I'm Richard, a Computer Engineering student at the University of Waterloo.👋
...
- **Frontend:** React, H5, CSS, Node.js
- **Backend:** JS/TS, Django, Flask, Node.js, FastAPI, MCP
...
- **CI/CD**: YAML, GitHub Actions, GitLab CICD
- **Machine Learning:** Tensorflow, Pytorch, SpaCy, SKLearn
- **Database:** PostgreSQL, MySQL, Redis
- **Others:** Docker, Git (obviously), VS/VSC/PyCharm, Anaconda, IntelliJ, Node/Yarn, etc
...
- 🌐 I speak English, Mandarin, and a decent amount of French (6/7 in IB SL French!). I'm also trying to learn Cantonese with [Duolingo](https://www.duolingo.com/) and Japanese with [HeyJapan](https://japanese.heylearning.net/).
